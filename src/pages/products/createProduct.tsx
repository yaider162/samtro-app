...
import { addProduct } from "../../utils/api.tsx";
...
export default function CreateProductPage({
  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    showConfirmation({
      ...
      message: `¿Estas seguro de guardar el producto !*#${product.name}!*# ?`,
  ...
  const handleSaveProduct = async () => {
    try {
      ...
      if (response === "Producto añadido a la base de datos") {
        setProduct({
          code: "",
          name: "",
          category: "",
      ...
      <div className="bg-white rounded-xl shadow-md p-8">
        <form className="space-y-6" onSubmit={handleSend}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-gray-700 font-medium mb-2">
                Código <span className="text-red-300">*</span>
              </label>
              <input
                type="text"
                name="code"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              <label className="block text-gray-700 font-medium mb-2">
                Stock Inicial <span className="text-red-300">*</span>
              </label>
              <input
                type="number"
                name="stock"
